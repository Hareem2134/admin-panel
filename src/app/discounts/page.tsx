  ...
  return (
    <AdminLayout>
      <div className="p-4 sm:p-6 max-w-6xl mx-auto">
        ...
        <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg sm:rounded-2xl shadow-md sm:shadow-xl mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-800">Create New Discount</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="flex flex-col sm:flex-row justify-end mt-6 gap-4">
            <button
              ...
              className="w-full sm:w-auto bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-all transform hover:scale-105 shadow-md sm:shadow-lg"
            >
              Generate New Code
            </button>
            <button
              onClick={createDiscount}
              className="w-full sm:w-auto bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 shadow-md sm:shadow-lg"
            >
              Create Discount
            </button>
          </div>
                ...
                {discounts
                  ...
                  .map((discount) => (
                    <tr key={discount._id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 whitespace-nowrap">{discount.code}</td>
                      <td className="px-4 py-3 whitespace-nowrap">{discount.type}</td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        {discount.type === "percentage" ? `${discount.value}%` : `$${discount.value}`}
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">{new Date(discount.expiry).toLocaleString()}</td>
                      <td className="px-4 py-3 whitespace-nowrap">{new Date(discount._createdAt).toLocaleString()}</td>
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <button
                          ...
                          className="text-red-600 hover:text-red-800 transition-colors px-2 py-1 rounded-md hover:bg-red-50"
                        >
                          Delete
                        </button>
                      </td>
